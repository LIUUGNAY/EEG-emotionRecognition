...
for k=1:32
    ...
    for j=1:40
       ...
       xxTheta.HAHV.PLV1.val=[xTheta.HAHV.PLV1 labelsvalence];
       xxAlpha.HAHV.PLV1.val=[xAlpha.HAHV.PLV1 labelsvalence];
       xxBeta1.HAHV.PLV1.val=[xBeta1.HAHV.PLV1 labelsvalence];
       xxBeta2.HAHV.PLV1.val=[xBeta2.HAHV.PLV1 labelsvalence];
       xxTheta.HAHV.PLV1.aro=[xTheta.HAHV.PLV1 labelsarousal];
       xxAlpha.HAHV.PLV1.aro=[xAlpha.HAHV.PLV1 labelsarousal];
       xxBeta1.HAHV.PLV1.aro=[xBeta1.HAHV.PLV1 labelsarousal];
       xxBeta2.HAHV.PLV1.aro=[xBeta2.HAHV.PLV1 labelsarousal];
       
       xxTheta.HALV.PLV1.val=[xTheta.HALV.PLV1 labelsvalence];
       xxAlpha.HALV.PLV1.val=[xAlpha.HALV.PLV1 labelsvalence];
       xxBeta1.HALV.PLV1.val=[xBeta1.HALV.PLV1 labelsvalence];
       xxBeta2.HALV.PLV1.val=[xBeta2.HALV.PLV1 labelsvalence]; 
       xxTheta.HALV.PLV1.aro=[xTheta.HALV.PLV1 labelsarousal];
       xxAlpha.HALV.PLV1.aro=[xAlpha.HALV.PLV1 labelsarousal];
       xxBeta1.HALV.PLV1.aro=[xBeta1.HALV.PLV1 labelsarousal];
       xxBeta2.HALV.PLV1.aro=[xBeta2.HALV.PLV1 labelsarousal];
       
       xxTheta.LAHV.PLV1.val=[xTheta.LAHV.PLV1 labelsvalence];
       xxAlpha.LAHV.PLV1.val=[xAlpha.LAHV.PLV1 labelsvalence];
       xxBeta1.LAHV.PLV1.val=[xBeta1.LAHV.PLV1 labelsvalence];
       xxBeta2.LAHV.PLV1.val=[xBeta2.LAHV.PLV1 labelsvalence];
      xxTheta.LAHV.PLV1.aro=[xTheta.LAHV.PLV1 labelsarousal];
       xxAlpha.LAHV.PLV1.aro=[xAlpha.LAHV.PLV1 labelsarousal];
       xxBeta1.LAHV.PLV1.aro=[xBeta1.LAHV.PLV1 labelsarousal];
       xxBeta2.LAHV.PLV1.aro=[xBeta2.LAHV.PLV1 labelsarousal];
       
       
       xxTheta.LALV.PLV1.aro=[xTheta.LALV.PLV1 labelsarousal];
       xxAlpha.LALV.PLV1.aro=[xAlpha.LALV.PLV1 labelsarousal];
       xxBeta1.LALV.PLV1.aro=[xBeta1.LALV.PLV1 labelsarousal];
       xxBeta2.LALV.PLV1.aro=[xBeta2.LALV.PLV1 labelsarousal];
       xxTheta.LALV.PLV1.val=[xTheta.LALV.PLV1 labelsvalence];
       xxAlpha.LALV.PLV1.val=[xAlpha.LALV.PLV1 labelsvalence];
       xxBeta1.LALV.PLV1.val=[xBeta1.LALV.PLV1 labelsvalence];
       xxBeta2.LALV.PLV1.val=[xBeta2.LALV.PLV1 labelsvalence];
       ...
       xxTheta.HAHV.PLV2.val=[xTheta.HAHV.PLV2 labelsvalence];
       xxAlpha.HAHV.PLV2.val=[xAlpha.HAHV.PLV2 labelsvalence];
       xxBeta1.HAHV.PLV2.val=[xBeta1.HAHV.PLV2 labelsvalence];
       xxBeta2.HAHV.PLV2.val=[xBeta2.HAHV.PLV2 labelsvalence];
       xxTheta.HAHV.PLV2.aro=[xTheta.HAHV.PLV2 labelsarousal];
       xxAlpha.HAHV.PLV2.aro=[xAlpha.HAHV.PLV2 labelsarousal];
       xxBeta1.HAHV.PLV2.aro=[xBeta1.HAHV.PLV2 labelsarousal];
       xxBeta2.HAHV.PLV2.aro=[xBeta2.HAHV.PLV2 labelsarousal];
      
       xxTheta.HALV.PLV2.val=[xTheta.HALV.PLV2 labelsvalence];
       xxAlpha.HALV.PLV2.val=[xAlpha.HALV.PLV2 labelsvalence];
       xxBeta1.HALV.PLV2.val=[xBeta1.HALV.PLV2 labelsvalence];
       xxBeta2.HALV.PLV2.val=[xBeta2.HALV.PLV2 labelsvalence]; 
       xxTheta.HALV.PLV2.aro=[xTheta.HALV.PLV2 labelsarousal];
       xxAlpha.HALV.PLV2.aro=[xAlpha.HALV.PLV2 labelsarousal];
       xxBeta1.HALV.PLV2.aro=[xBeta1.HALV.PLV2 labelsarousal];
       xxBeta2.HALV.PLV2.aro=[xBeta2.HALV.PLV2 labelsarousal];
       
       xxTheta.LAHV.PLV2.val=[xTheta.LAHV.PLV2 labelsvalence];
       xxAlpha.LAHV.PLV2.val=[xAlpha.LAHV.PLV2 labelsvalence];
       xxBeta1.LAHV.PLV2.val=[xBeta1.LAHV.PLV2 labelsvalence];
       xxBeta2.LAHV.PLV2.val=[xBeta2.LAHV.PLV2 labelsvalence];
      xxTheta.LAHV.PLV2.aro=[xTheta.LAHV.PLV2 labelsarousal];
       xxAlpha.LAHV.PLV2.aro=[xAlpha.LAHV.PLV2 labelsarousal];
       xxBeta1.LAHV.PLV2.aro=[xBeta1.LAHV.PLV2  labelsarousal];
       xxBeta2.LAHV.PLV2.aro=[xBeta2.LAHV.PLV2 labelsarousal];
       
       
       xxTheta.LALV.PLV2.aro=[xTheta.LALV.PLV2 labelsarousal];
       xxAlpha.LALV.PLV2.aro=[xAlpha.LALV.PLV2 labelsarousal];
       xxBeta1.LALV.PLV2.aro=[xBeta1.LALV.PLV2 labelsarousal];
       xxBeta2.LALV.PLV2.aro=[xBeta2.LALV.PLV2 labelsarousal];
       xxTheta.LALV.PLV2.val=[xTheta.LALV.PLV2 labelsvalence];
       xxAlpha.LALV.PLV2.val=[xAlpha.LALV.PLV2 labelsvalence];
       xxBeta1.LALV.PLV2.val=[xBeta1.LALV.PLV2 labelsvalence];
       xxBeta2.LALV.PLV2.val=[xBeta2.LALV.PLV2 labelsvalence];
