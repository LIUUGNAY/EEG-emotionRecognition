...
xxTheVal=x.Theta.PLV1.valence;
xxTheAro=x.Theta.PLV1.arousal;
xxAlpVal=x.Alpha.PLV1.valence;
xxAlpAro=x.Alpha.PLV1.arousal;
xxBe1Val=x.Beta1.PLV1.valence;
xxBe1Aro=x.Beta1.PLV1.arousal;
xxBe2Val=x.Beta2.PLV1.valence;
xxBe2Aro=x.Beta2.PLV1.arousal;
